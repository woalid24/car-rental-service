      ...
      <div className="relative flex-1">
        <Menu.Button className="dropdown-btn h-full w-full flex flex-col justify-center items-center xl:items-start xl:pl-8">
          ...
          <div className="flex flex-col xl:flex-row items-center xl:gap-x-2 gap-y-2 xl:gap-y-0">
            {" "}
            <FaCalendarAlt className="text-accent-DEFFAULT" />{" "}
            <div className="uppercase text-[15px] font-bold">Selact Date</div>
          </div>
        ...
        <Menu.Items className="dropdown-menu shadow-lg absolute -top-96 xl:top-[90px] left-1/2 xl:left-0 z-50 transform -translate-x-1/2 xl:translate-x-0  rounded-[10px] overflow-hidden">
          <DateRange
            onChange={(item) => setDate([item.selaction])}
